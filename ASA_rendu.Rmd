...
-   **ID**, variable qualitative nominales représentant les individus identifiés
...
Préalablement les colones **ID** et **PIC** ont été modifié au vue de la structure hiérarchique de celles-ci. **ID** est une variable imbriquée dans la variable **treatement** , où chaque classe de **treatement** à un ensemble de classe d’**ID**. Le même imbriquement est présent pour **PIC**, qui est imbriqué dans la variable **ID**. Ces deux variables (**ID** et **PIC**) sont donc représenter par leur **treatement**, (ex : 1Con, pour l’individu 1 du traitement control), ou bien par leur **treatement** et leur ID (ex: 3F - 6, pour la photo 6 de l’individu 3 du traitement Freezing).
